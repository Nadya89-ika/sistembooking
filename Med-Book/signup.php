        ...
        <table border="0">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">Tambahkan Data Diri</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td">
                    <input type="text" name="fname" class="input-text" placeholder="Nama Awal" required>
                </td>
                <td class="label-td">
                    <input type="text" name="lname" class="input-text" placeholder="Nama Akhir" required>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                ...
                <td>
                    <input type="submit" value="Lanjut" class="login-btn btn-primary btn">
                </td>
