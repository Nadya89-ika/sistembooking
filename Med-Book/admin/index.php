            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active" >
                        <a href="index.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dasbor</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Janji</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Janji Temu Mendatang Sampai Sabtu Depan <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Berikut akses cepat ke Janji Temu Mendatang hingga 7 hari.<br>
                                    Rincian selengkapnya tersedia di bagian Janji.
                                    </p>
                                ...
                                <td>
                                    ...
                                    Sesi Mendatang hingga Sabtu Depan <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    ...
                                    Berikut akses Cepat ke Sesi Mendatang yang Dijadwalkan hingga 7 hari<br>
                                    Tambah, Hapus, dan Banyak fitur yang tersedia di bagian Jadwal.
                                    </p>
                                </td>
                            </tr>
                            <tr>
