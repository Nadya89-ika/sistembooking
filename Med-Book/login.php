...
<body>
    ...
    <div class="container">
        <table border="0" style="margin: 0;padding: 0;width: 60%;">
            <tr>
                <td>
                    <p class="header-text">SELAMAT DATANG!</p>
                </td>
            </tr>
        <div class="form-body">
            <tr>
                <td>
                    <p class="sub-text">Login Sekarang Juga</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td">
                    <input type="email" name="useremail" class="input-text" placeholder="abc@abcmail.com" required>
                </td>
            </tr>
            <tr>
                <td class="label-td">
